...
$selectquery = "select * from found_data ORDER BY create_at DESC";
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                        ...
                        <div class="col-sm-4 col-sm-offset-5">
                            <form action="" method="post">
                                <div class="claimbutton">
                                 ...
                                 <button class="btn btn-primary" value="Claim" name= "claim_found" id="login-button" type="submit">Claim!</button>
                               </div>
                    ...
                    <h3>Claimed person's details</h3><br>

                </div>

								<?php
								if (isset($_POST['claim_found'])){
								if(isset($_SESSION['useremail'])){

										//  $_SESSION['found_id'] = $q['found_id'];
											 $_SESSION['username'] ;

											$_SESSION['useremail'] ;

												 $q['found_id'];
												 $claimed_users_data_insert= "INSERT INTO claimed_users (claimed_name, claimed_email, found_id) VALUES ('$_SESSION[username]', '$_SESSION[useremail]', '$q[found_id]')";
												 $claimed_users_query = mysqli_query($con, $claimed_users_data_insert);
												 if ($claimed_users_query) {
													// code...
